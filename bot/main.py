...
bot = telebot.TeleBot("1831877738:AAEcHBt3InACR0bcZ7TgBXgseI9_Ha_iJbU")
...
def getFoodsByRestaurantId(id):
    ...
    sql = "SELECT f.id, f.name, f.price, f.description, f.restaurant_id, f.id, ft.name as foodType, r.name as restaurantName " \
    "FROM foods f " \
    "LEFT OUTER JOIN food_types ft ON ft.id = f.id " \
